...
import 'package:optimize/screens/idea_detail_screen.dart';
...
class IdeaWidget extends StatelessWidget {
  ...
  const IdeaWidget({Key? key, required this.data, this.marginBottom = 0})
      : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => IdeaDetailScreen(data: data),
          ),
        );
      },
      child: SizedBox(
